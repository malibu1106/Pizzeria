...
WHERE order_status = 'preparation'
        ...
        <div class="card mb-3 border-warning">
            ...
            <div class="list-unstyled mt-3">
                    ...
                    <div class="mb-3 d-flex justify-content-between align-items-center px-4">
                            ...
                            <a href="update_status.php?switch=reverse&status=recue&order_id=<?=$order['order_id']?>">
                                <div class="switch-status-arrow bg-dark"><</div>
                            </a>

                            <a href="update_status.php?status=prete&order_id=<?=$order['order_id']?>">
                                <div class="switch-status-arrow bg-danger">></div>
                            </a>
